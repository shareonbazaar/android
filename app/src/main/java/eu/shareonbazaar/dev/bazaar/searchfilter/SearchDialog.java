package eu.shareonbazaar.dev.bazaar.searchfilter;
...
import eu.shareonbazaar.dev.bazaar.model.SkillCategory;
import eu.shareonbazaar.dev.bazaar.network.ConnectionSetup;
import eu.shareonbazaar.dev.bazaar.network.UserService;
import eu.shareonbazaar.dev.bazaar.network.skillcategory.SkillCategoryService;
...
public class SearchDialog extends DialogFragment{
    ...
    private void fetchSkills(){
        SkillCategoryService service = ConnectionSetup.retrofit.create(SkillCategoryService.class);
        service.getSkills()
